use crate::component::{Profile, Request, Response, Task, UserAgent, ResError};
use crate::component::ParseResult;
use hyper::{ Request as hRequest, Body };
...
pub trait Spider<T> {
    ...
    fn open_spider(&self) -> (Option<Vec<UserAgent>>, Option<Vec<Request>>, Option<Vec<Task>>, Option<Vec<Profile>>,) ;
